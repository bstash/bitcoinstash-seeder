...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "BitcoinStash-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.bstash.org", "dnsseed.bstash2.org", ""};
static const string testnet_seeds[] = {"testnet-seed.bstash", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 10101), true);
  }
  do {
